<%@ Page Title="Jeanious Denim" Language="C#" MasterPageFile="~/Masterpage.Master" AutoEventWireup="true" CodeBehind="Jeans.aspx.cs" Inherits="RetailShopSystem.Jeans" %>
...
.one {
	background: url('images/JEAN4.jpg');
...
.two {
	background: url('Images/jacket jean.png');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.three {
	background: url('images/JEAN2.jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
...
.five {
	background: url('Images/SKIRT (2).jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.six {
	background: url('images/JEAN3.jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.seven {
	background: url('Images/SKIRT (1).jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.eight {
	background: url('Images/JEAN1.jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.nine {
	background: url('Images/SKIRT (3).jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.ten {
	background: url('Images/Jacket (1).jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
.eleven {
	background: url('Images/Jacket (2).jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
...
.tlv {
	background: url('Images/Jacket (3).jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
...
.ftn {
	background: url('Images/Jacket (4).jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
...
.sith {
	background: url('Images/SKIRT (4).jpg');
	background-repeat: no-repeat;
	background-size: cover;
	background-position: center;
}
...
/*  FOLLOW*/
.Follow {	  background:url("Images/treschic.jpg")no-repeat center / contain;
	width: 50px;
	height: 50px;
	bottom: 9px;
	right: 20px;
...
<!-- FOLLOW -->
<a class="Follow" href="Default.aspx" target="blank_"></a>
